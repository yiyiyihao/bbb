...
CREATE TABLE `wja_auth_rule`  (
  ...
  `action` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'action节点',
...
) ENGINE = MyISAM AUTO_INCREMENT = 13 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限节点' ROW_FORMAT = Dynamic;
...
INSERT INTO `wja_auth_rule` VALUES (2, 1, 'admin', 'index', 'home', '后台首页', '', 1, 1, 10, 1, 1, 1542972567, 1543216125, 0);
...
INSERT INTO `wja_auth_rule` VALUES (11, 1, 'admin', 'authrule', '', '系统管理', 'setting', 0, 1, 6, 1, 1, 1543049795, 1543057388, 0);
...
) ENGINE = MyISAM AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '渠道等级表' ROW_FORMAT = Dynamic;
...
) ENGINE = MyISAM AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '厂商数据表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wja_field`  (
  ...
  `type` tinyint(1) UNSIGNED NULL DEFAULT 1 COMMENT '数据类型 1 文本 2 文本域 3 密码 4 单选 5 复选 6 下拉单选 7 下拉复选 8 搜索单选 9 搜索复选 10 联动单选 11 单图上传 12 多图上传 13 多图上传+封面图 14 编辑器',
...
) ENGINE = MyISAM AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '产品表' ROW_FORMAT = Dynamic;
...
) ENGINE = MyISAM AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '产品分类表' ROW_FORMAT = Dynamic;
...
) ENGINE = MyISAM AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '产品规格表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `wja_store` VALUES (1, 0, 1, '万佳安', '', '', 1, 1, 1542941728, 1542941728, 0);
INSERT INTO `wja_store` VALUES (2, 0, 1, '测试厂商', '', '', 1, 1, 1542941746, 1543197927, 0);
INSERT INTO `wja_store` VALUES (3, 1, 2, '广东', '', '', 1, 1, 1542941909, 1542941909, 0);
...
) ENGINE = MyISAM AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '前台会员表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wja_user
-- ----------------------------
INSERT INTO `wja_user` VALUES (1, 1, 0, 1, 0, 'admin', 'f62df18cf9f77c1ddd315da773e0a18b', '', 'xiaojun', '13587458745', '', 0.00, '', '', 1, 255, 1542683553, 1543228928, 1543228928, 0);
INSERT INTO `wja_user` VALUES (2, 2, 0, 2, 0, 'wanjiaan', 'f03be5a5d3fa6933cbe31b3817728515', '', '', '', '', 0.00, '', '', 1, 1, 1542941728, 1542941728, 1543043735, 0);
INSERT INTO `wja_user` VALUES (3, 2, 0, 2, 0, 'ceshi', '3de54ec60cfd102a6f0e6a7211a5be1c', '', '', '', '', 0.00, '', '', 1, 1, 1542941746, 1542941746, 1543031540, 0);
INSERT INTO `wja_user` VALUES (4, 2, 0, 2, 0, 'guangdong', '26ae6aec7364ba130021ba3f5850a151', '', '', '', '', 0.00, '', '', 1, 1, 1542941909, 1542941909, 0, 0);
...
) ENGINE = MyISAM AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户分组表' ROW_FORMAT = Dynamic;
