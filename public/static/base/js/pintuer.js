$(function(){
	...
	$(".select-box .select-group .select-item").click(function(){
		var value = $(this).data("value");
		var formname = '';
		formname = $(this).parent().parent().parent().find(".group-title .group-item").data("name");
		$(this).parent().parent().parent().find(".group-title .group-item").data("value",value).text(value);
