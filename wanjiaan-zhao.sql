...
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '接口访问日志表' ROW_FORMAT = Dynamic;
...
) ENGINE = MyISAM AUTO_INCREMENT = 67 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限节点' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wja_auth_rule
-- ----------------------------
INSERT INTO `wja_auth_rule` VALUES (1, 1, 'admin', 'index', 'index', '后台登录', 'home', 0, 1, 1, 1, 1, 1542954178, 1542972063, 0);
...
INSERT INTO `wja_auth_rule` VALUES (9, 1, 'admin', 'authrule', 'index', '权限列表', '', 8, 1, 31, 1, 1, 1543216929, 1543473310, 0);
...
INSERT INTO `wja_auth_rule` VALUES (44, 1, 'admin', 'user', 'index', '账户管理', '', 10, 1, 46, 1, 1, 1543289903, 1543473227, 0);
INSERT INTO `wja_auth_rule` VALUES (45, 1, 'admin', 'ugroup', 'index', '角色管理', '', 10, 1, 41, 1, 1, 1543289903, 1543473176, 0);
INSERT INTO `wja_auth_rule` VALUES (46, 1, 'admin', 'factory', 'config', '厂商参数配置', '', 10, 1, 4, 1, 1, 1543371506, 1543371506, 0);
...
INSERT INTO `wja_auth_rule` VALUES (56, 1, 'admin', 'user', 'add', '新增账户', '..', 10, 1, 47, 0, 1, 1543465751, 1543473250, 0);
INSERT INTO `wja_auth_rule` VALUES (57, 1, 'admin', 'user', 'del', '删除账户', '..', 10, 1, 48, 0, 1, 1543472404, 1543473259, 0);
INSERT INTO `wja_auth_rule` VALUES (58, 1, 'admin', 'user', 'edit', '编辑账户', '..', 10, 1, 49, 0, 1, 1543472456, 1543473270, 0);
INSERT INTO `wja_auth_rule` VALUES (59, 1, 'admin', 'authrule', 'add', '新增权限', '..', 8, 1, 32, 0, 1, 1543472522, 1543473318, 0);
INSERT INTO `wja_auth_rule` VALUES (60, 1, 'admin', 'authrule', 'del', '删除权限', '..', 8, 1, 33, 0, 1, 1543472557, 1543473325, 0);
INSERT INTO `wja_auth_rule` VALUES (61, 1, 'admin', 'authrule', 'edit', '编辑权限', '..', 8, 1, 34, 0, 1, 1543472602, 1543473331, 0);
INSERT INTO `wja_auth_rule` VALUES (62, 1, 'admin', 'ugroup', 'add', '新增角色', '..', 10, 1, 42, 0, 1, 1543473061, 1543473189, 0);
INSERT INTO `wja_auth_rule` VALUES (63, 1, 'admin', 'ugroup', 'del', '删除角色', '..', 10, 1, 43, 0, 1, 1543473118, 1543473199, 0);
INSERT INTO `wja_auth_rule` VALUES (64, 1, 'admin', 'ugroup', 'edit', '编辑角色', '..', 10, 1, 44, 0, 1, 1543473160, 1543473210, 0);
INSERT INTO `wja_auth_rule` VALUES (65, 1, 'admin', 'authrule', 'purview', '授权权限', '..', 8, 1, 35, 0, 1, 1543473597, 1543473796, 1);
INSERT INTO `wja_auth_rule` VALUES (66, 1, 'admin', 'ugroup', 'purview', '授权角色', '..', 10, 1, 45, 0, 1, 1543473833, 1543473833, 0);
...
) ENGINE = MyISAM AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '渠道等级表' ROW_FORMAT = Dynamic;
...
) ENGINE = MyISAM AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '产品分类表' ROW_FORMAT = Dynamic;
...
) ENGINE = MyISAM AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '产品规格表' ROW_FORMAT = Dynamic;
...
INSERT INTO `wja_store` VALUES (2, 0, 1, '测试厂商', '', '', 1, 1, 1543288024, 1543313576, 0, 'http://pimvhcf3v.bkt.clouddn.com/store_logo_20181127181255_logo1.jpg');
...
CREATE TABLE `wja_store_channel`  (
  ...
  PRIMARY KEY (`store_id`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '渠道商数据表' ROW_FORMAT = Fixed;
...
) ENGINE = MyISAM AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '前台会员表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wja_user
-- ----------------------------
INSERT INTO `wja_user` VALUES (1, 1, 0, 0, 0, 'admin', 'f62df18cf9f77c1ddd315da773e0a18b', '', 'xiaojun', '13587458745', '', 0.00, '', '', 1, 1, 1542683553, 1543473854, 1543473854, 0);
INSERT INTO `wja_user` VALUES (2, 2, 1, 0, 0, 'wanjiaan', 'f03be5a5d3fa6933cbe31b3817728515', '', '', '13458745748', '', 0.00, '', '', 1, 1, 1543223533, 1543376905, 1543376905, 0);
INSERT INTO `wja_user` VALUES (3, 2, 2, 0, 0, 'ceshi', '3de54ec60cfd102a6f0e6a7211a5be1c', '', '', '', '', 0.00, '', '', 1, 1, 1543288394, 1543288394, 0, 0);
INSERT INTO `wja_user` VALUES (4, 3, 3, 0, 0, 'qudao', 'e8c94a39f248ffd0973920279f7a9a89', '', '', '', '', 0.00, '', '', 1, 1, 1543302686, 1543376892, 1543376892, 0);
...
INSERT INTO `wja_user` VALUES (6, 1, 0, 5, 0, 'yonghua', 'f62df18cf9f77c1ddd315da773e0a18b', '', '', '13522252222', '', 0.00, '', '', 1, 1, 1543398114, 1543473966, 1543464893, 1);
INSERT INTO `wja_user` VALUES (7, 1, 0, 6, 0, 'yonghuc', 'f62df18cf9f77c1ddd315da773e0a18b', '', '', '13522222222', '', 0.00, '', '', 1, 1, 1543406018, 1543473968, 1543464884, 1);
INSERT INTO `wja_user` VALUES (8, 1, 0, 7, 0, 'yonghuaaa', 'f62df18cf9f77c1ddd315da773e0a18b', '', '', '15822222222', '', 0.00, '', '', 1, 1, 1543473960, 1543473997, 1543473997, 0);
...
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员收货地址' ROW_FORMAT = Dynamic;
...
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员第三方账号表' ROW_FORMAT = Dynamic;
...
INSERT INTO `wja_user_group` VALUES (4, 0, '角色b', 0, 1, 255, 0, 1543397110, 1543397110, '');
INSERT INTO `wja_user_group` VALUES (5, 0, '测试a', 0, 1, 254, 0, 1543397119, 1543397119, '');
INSERT INTO `wja_user_group` VALUES (6, 0, '测试c', 0, 1, 255, 0, 1543405996, 1543405996, '[{\"id\":1,\"rule\":\"admin\\/index\\/\",\"parent_id\":0,\"menustatus\":1,\"title\":\"\\u540e\\u53f0\\u767b\\u5f55\"},{\"id\":2,\"rule\":\"admin\\/index\\/home\",\"parent_id\":1,\"menustatus\":1,\"title\":\"\\u540e\\u53f0\\u9996\\u9875\"},{\"id\":3,\"rule\":\"admin\\/factory\\/\",\"parent_id\":0,\"menustatus\":1,\"title\":\"\\u5382\\u5546\\u7ba1\\u7406\"},{\"id\":7,\"rule\":\"admin\\/factory\\/del\",\"parent_id\":3,\"menustatus\":0,\"title\":\"\\u5220\\u9664\\u5382\\u5546\"}]');
INSERT INTO `wja_user_group` VALUES (7, 0, 'jueseaaa', 0, 1, 255, 0, 1543473643, 1543473643, '[{\"id\":1,\"rule\":\"admin\\/index\\/index\",\"parent_id\":0,\"menustatus\":1,\"title\":\"\\u540e\\u53f0\\u767b\\u5f55\"},{\"id\":2,\"rule\":\"admin\\/index\\/home\",\"parent_id\":1,\"menustatus\":1,\"title\":\"\\u540e\\u53f0\\u9996\\u9875\"},{\"id\":3,\"rule\":\"admin\\/factory\\/\",\"parent_id\":0,\"menustatus\":1,\"title\":\"\\u5382\\u5546\\u7ba1\\u7406\"},{\"id\":7,\"rule\":\"admin\\/factory\\/del\",\"parent_id\":3,\"menustatus\":0,\"title\":\"\\u5220\\u9664\\u5382\\u5546\"},{\"id\":6,\"rule\":\"admin\\/factory\\/edit\",\"parent_id\":3,\"menustatus\":0,\"title\":\"\\u7f16\\u8f91\\u5382\\u5546\"},{\"id\":5,\"rule\":\"admin\\/factory\\/add\",\"parent_id\":3,\"menustatus\":0,\"title\":\"\\u65b0\\u589e\\u5382\\u5546\"},{\"id\":4,\"rule\":\"admin\\/factory\\/index\",\"parent_id\":3,\"menustatus\":1,\"title\":\"\\u5382\\u5546\\u5217\\u8868\"},{\"id\":8,\"rule\":\"admin\\/authrule\\/\",\"parent_id\":0,\"menustatus\":1,\"title\":\"\\u6743\\u9650\\u7ba1\\u7406\"},{\"id\":9,\"rule\":\"admin\\/authrule\\/index\",\"parent_id\":8,\"menustatus\":1,\"title\":\"\\u6743\\u9650\\u5217\\u8868\"},{\"id\":59,\"rule\":\"admin\\/authrule\\/add\",\"parent_id\":8,\"menustatus\":0,\"title\":\"\\u65b0\\u589e\\u6743\\u9650\"},{\"id\":10,\"rule\":\"admin\\/sysadmin\\/\",\"parent_id\":0,\"menustatus\":1,\"title\":\"\\u7cfb\\u7edf\\u914d\\u7f6e\"},{\"id\":46,\"rule\":\"admin\\/factory\\/config\",\"parent_id\":10,\"menustatus\":1,\"title\":\"\\u5382\\u5546\\u53c2\\u6570\\u914d\\u7f6e\"},{\"id\":11,\"rule\":\"admin\\/system\\/grant\",\"parent_id\":10,\"menustatus\":1,\"title\":\"\\u6743\\u9650\\u914d\\u7f6e\"},{\"id\":45,\"rule\":\"admin\\/ugroup\\/index\",\"parent_id\":10,\"menustatus\":1,\"title\":\"\\u89d2\\u8272\\u7ba1\\u7406\"},{\"id\":44,\"rule\":\"admin\\/user\\/index\",\"parent_id\":10,\"menustatus\":1,\"title\":\"\\u8d26\\u6237\\u7ba1\\u7406\"}]');
...
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '安装员数据表' ROW_FORMAT = Dynamic;
