...
class Admin extends Index
{
    ...
    protected function login()
    {
        ...
        $where = [
            ...
            ['username',    '=', $username],
            ['group_id',    '>', 0],
//             ['admin_type',  'IN', [ADMIN_FACTORY, ADMIN_CHANNEL, ADMIN_DEALER, ADMIN_SERVICE, ADMIN_SERVICE_NEW]],
            ['admin_type',  'IN', [ADMIN_FACTORY, ADMIN_DEALER, ADMIN_SERVICE_NEW]],
            ['is_admin',    '>', 0],
        ];
