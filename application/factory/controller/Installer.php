...
//售后工程师管理
class Installer extends FactoryForm
{
    var $adminType;
    ...
    function _tableData(){
        $table = [
            ...
            ['title'     => '工号','width'  => '*','value'      => 'realname','type'      => 'text'],
            ['title'     => '头像','width'  => '*','value'      => 'realname','type'      => 'text'],
            ['title'     => '服务区域','width'  => '*','value'      => 'realname','type'      => 'text'],
            ['title'     => '从业时间','width'  => '*','value'      => 'work_time','type'      => 'text'],
